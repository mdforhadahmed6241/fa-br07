...
// Bumping the version number to 1.6.5 for Product Report update.
define( 'BR_PLUGIN_VERSION', '1.6.5' );
...
final class Business_Report {
	...
	private function includes() {
        ...
        $required_files = [
            ...
            'includes/cogs-functions.php', // UPDATED: Replaced cogs-management.php
            'includes/meta-ads.php',
            'includes/expense-management.php',
            'includes/order-report.php',
            'includes/product-report.php' // NEW: Added product report page
        ];
	...
	public function admin_menu() {
        ...
        if ($main_page_hook) {
            ...
            // REMOVED: Old COGS Management page
