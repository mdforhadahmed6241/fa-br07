...
function br_settings_page_html() {
    ...
    // REMOVED: The check and require_once for cogs-management.php
    // The functions are now loaded globally via cogs-functions.php in business-report.php
...
function br_register_all_settings() {
    ...
    // All callback functions (e.g., 'br_cogs_settings_sanitize') are now in cogs-functions.php
